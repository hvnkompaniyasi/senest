  ...
  return (
    <section className="pb-6">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <Link href="/listings" className="inline-flex items-center gap-1 text-xs font-bold text-[#0A7C4E]">
      ...
      {listings.length === 0 ? (
        <div className="text-center py-12 bg-white dark:bg-zinc-900 rounded-2xl border border-gray-100 dark:border-zinc-800">
          ...
          <Link href="/add-listing" className="text-xs font-bold text-[#0A7C4E]">
