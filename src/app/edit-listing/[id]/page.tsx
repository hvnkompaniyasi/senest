      ...
      <div className="min-h-screen bg-[#F7FBF8] dark:bg-zinc-950 flex items-center justify-center px-4 pb-24">
        <div className="max-w-sm w-full bg-white dark:bg-zinc-900 rounded-2xl p-6 text-center shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
          ...
          <button
            ...
            className="h-12 w-full bg-gradient-to-r from-[#0A7C4E] to-[#08623D] text-white rounded-xl font-bold text-sm"
          >
  ...
  return (
    <div className="min-h-screen bg-[#F7FBF8] dark:bg-zinc-950 pb-24 lg:pb-10">
      ...
      <div className="max-w-2xl mx-auto px-3 sm:px-6 py-4 space-y-4">
        <Link href="/my-listings" className="inline-flex items-center gap-1.5 text-sm font-semibold text-gray-600 dark:text-gray-300 hover:text-[#0A7C4E]">
        ...
        <button
          ...
          className="h-14 w-full bg-gradient-to-r from-[#0A7C4E] to-[#08623D] hover:from-[#0A7C4E] hover:to-[#08623D] text-white rounded-2xl font-extrabold text-base flex items-center justify-center gap-2 shadow-lg shadow-green-400/30 disabled:opacity-50"
        >
